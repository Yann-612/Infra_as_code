...
# This file contains the provider configuration for Terraform to interact with Azure.
# It specifies the required provider and its version, as well as the authentication details for Azure.
provider "azurerm" {
